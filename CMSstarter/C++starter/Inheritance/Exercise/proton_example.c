...
int main() 
{
  ...
  cout<< "; energy = " << pr1.GetEnergy();
  cout<<"; Lifetime = "<< pr1.GetLifetime();
  cout<<"; Charge = "<< pr1.GetCharge() <<endl;
  ...
  cout<< "; energy = " << pr2.GetEnergy();
  cout<<"; Lifetime = "<< pr2.GetLifetime();
  cout<<"; Charge = "<< pr2.GetCharge() << endl;
