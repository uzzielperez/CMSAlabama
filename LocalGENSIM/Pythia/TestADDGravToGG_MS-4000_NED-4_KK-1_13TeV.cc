...
int main() {
  ...
  // LED parameters
  pythia.readString("ExtraDimensionsLED:MD = 1128"); // Fundamental scale of gravity, Ms = 4.
  pythia.readString("ExtraDimensionsLED:n = 2"); // number of extradimensions, default =2 
  pythia.readString("ExtraDimensionsLED:LambdaT = 1128"); // Ultraviolet cutoff for the virtual graviton exchange
